...
def train_model(n_pca):
    ...
    lbls= [
        'Real_Player', 'Smithing_bot', 'Mining_bot', 'Magic_bot', 'PVM_Ranged_bot', 
        'Wintertodt_bot', 'Fletching_bot', 'PVM_Melee_bot', 'Herblore_bot','Thieving_bot',
        'PVM_Ranged_Magic_bot','Crafting_bot']

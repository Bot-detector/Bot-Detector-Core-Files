...
PLAYER_IND_df = pd.DataFrame(my_array, columns = [
"ATTACK",
"DEFENCE" ,
"STRENGTH" ,
"HITPOINTS", 
...
PLAYER_TRUE_RESHAPE = np.resize(PLAYER_STATS_PREMEAN,(ENTRIES,79))
...
group_mean_array_grouped = np.reshape(group_mean_array_numpy_int,(n_clusters,79))
...
"CONSTRUCTION" : 22,
"LEAGUE" : 23,
"BOUNTY_HUNTER_HUNTER":24,
"BOUNTY_HUNTER_ROGUE":25,
"CS_ALL":26,
"CS_BEGINNER":26, ##fix later
"CS_EASY":27,
"CS_MEDIUM":28,
"CS_HARD":29,
"CS_ELITE":30,

...
@router.get("/scraper/players/{page}/{amount}/{token}", tags=["Scraper Routes","Business Routes"])
...
@router.post("/scraper/hiscores/{token}", tags=["Scraper Routes","Business Routes"])
